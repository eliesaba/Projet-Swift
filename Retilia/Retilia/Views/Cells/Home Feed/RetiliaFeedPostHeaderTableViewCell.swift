...
protocol RetiliaFeedPostHeaderTableViewCellDelegate: AnyObject {
    func didTapMoreButton()
}



class RetiliaFeedPostHeaderTableViewCell: UITableViewCell {
    
    weak var delegate: RetiliaFeedPostHeaderTableViewCellDelegate?
    
    static let identifier = "RetiliaFeedPostHeaderTableViewCell"
